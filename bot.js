...
const MSG4_ENTITIES = [
  ...
  { offset: 38,  length: 2, type: "custom_emoji", custom_emoji_id: "5253742260054409879" }, // ✉️
  ...
  { offset: 131, length: 11, type: "mention" },                                              // @Earn_arjun
  { offset: 143, length: 2, type: "custom_emoji", custom_emoji_id: "6296218646284863141" }, // ❤️
];
...
bot.on("chat_join_request", async (ctx) => {
  ...
  try {
    ...
    // MSG 3 — Verify message + green button
